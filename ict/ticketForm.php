...
if (isset($_POST['submitTicket'])) {
    ...
    $_SESSION['approved_reco'] = 0;
    $_SESSION['icthead_reco_remarks'] = NULL;
    if (!empty($r_personnels && $requestor && $ticket_category)) {
        if (isset($_POST['on_the_spot'])) {
            ...
            $sql = mysqli_query($con, "INSERT INTO request (date_filled, status2, requestor, requestorUsername, email, department, request_type, request_to, request_category, request_details, assignedPersonnel, assignedPersonnelName, assistantsId, assistanNames, ticket_category, category_level, ticket_filer)
             VALUES ('$datenow', '$status', '$requestor','$requestorIdnumber', '$requestorEmail', '$requestorDepartment', 'Technical Support', 'mis', '$ticket_category','$detailsOfRequest', '$r_personnels', '$r_personnelsName', '$r_assistants','$r_assistantsName', '$ticket_category', '$r_cat_level', '$user_name')");
        }
                ...
                if ($onthespot_ticket == '1') {
                    ...
                    <body>
                      <div class="container">
                        ...
                        <p>Hi ' . $requestor . ',</p>
                        <p>Your ticket request has been closed</p>
                        ...
                        <p>If you agree with the closure of this ticket, please click the link below to confirm: </p>
                        <p> Click <a href="' . $requestorApprovalLink . '">this</a>  to confirm. </p>
                        <div class="footer">
                    ...
                    <body>
                      <div class="container">
                        ...
                        <p class="highlight">Please wait for the ICT Administrator&#39s approval.</p>
