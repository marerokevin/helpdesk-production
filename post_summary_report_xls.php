...
echo "  <center> ";
echo "        <b>";
echo "            <font color='blue'>GLORY (PHILIPPINES), INC.</font>";
echo "        </b>";
echo "        <br>";
echo "        <b>ICT Helpdesk </b>";
echo "        <br>";
echo "        <h3> <b> Summary Report for the Month of  $month </b></h3>";
...
echo "            <thead>";
echo "                <tr>";
echo "                    <th rowspan='2'>Request No.</th>";
echo "                    <th rowspan='2'>Requestor</th>";
echo "                    <th rowspan='2'>Department</th>";
echo "                    <th rowspan='2'>Request Type (Category)</th>";
echo "                    <th rowspan='2'>Request Details</th>";
echo "                    <th rowspan='2'>In-charge</th>";
echo "                    <th colspan='3'>Requirements</th>";
echo "                    <th rowspan='2'>ICT Date Approval</th>";
echo "                    <th rowspan='2'>Date Responded</th>";
echo "                    <th rowspan='2'>Response Rate (Hours)</th>";
echo "                    <th rowspan='2'>Remarks</th>";
echo "                    <th rowspan='2'>Date Finished</th>";
echo "                    <th rowspan='2'>Accomplishment Rate (Days)</th>";
echo "                    <th rowspan='2'>Remarks</th>";
echo "                    <th rowspan='2'>Closed by</th>";
echo "                    <th rowspan='2'>Action Taken</th>";
echo "                    <th rowspan='2'>Recommendation</th>";
echo "                </tr>";
echo "                <tr>";
